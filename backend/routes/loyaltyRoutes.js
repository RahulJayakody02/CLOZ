...
// ✅ Route to add a purchase and update loyalty points (pass phone number as a param)
/*router.post(
  "/:phone/addPurchaseAndPoints",
  loyaltyController.addPurchaseAndPoints
);*/

// ✅ Route to get a customer's loyalty points by phone number
//router.get("/:phone/getLoyaltyPoints", loyaltyController.getLoyaltyPoints);

// ✅ Route to get a customer's purchase history by phone number
//router.get("/:phone/getPurchaseHistory", loyaltyController.getPurchaseHistory);
